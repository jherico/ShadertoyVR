...
protected:
  ...
  virtual void setChannelTextureInternal(int channel, st::ChannelInputType type, const QString & textureSource);

  virtual void setShaderInternal(const st::Shader & shader);
